...
import donatefootware from '../Images/DonateFootware.jpg'
import '../styles/DonateClothes.css'
import { Button, Col, Form, Row } from 'react-bootstrap'
import axios from "axios";
function DonateFootware() {
    ...
    const handleclick = (e) => {
        ...
        axios.post("http://192.168.3.97:5000/api/Footwear/", obj, {
            auth: {
                username: "ramesh",
                password: 12345
            }
        ...
        <div>
            ...
            <div className="row">
                <div className='col-lg-6 col-md-6 col-6'>
                    <img src={donatefootware} style={{ height: "709px" }} />
                </div>
                <div className='col-lg-6 col-md-6 col-6'>
                <Form>
                        <h3 className='textHeading mt-4'>Donate Gadgets</h3>
