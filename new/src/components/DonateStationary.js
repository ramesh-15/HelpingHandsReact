...
function DonateStationary() {
    ...
    const handleclick = (e) => {
        ...
        axios.post("http://192.168.3.97:5000/api/Stationary/", obj, {
            auth: {
                username: "ramesh",
                password: 12345
            }
    ...
    return (
        <div>
            ...
            <div className="row">
                ...
                <div className='col-lg-6 col-md-6 col-6'>
                <Form>
                        <h3 className='textHeading mt-4'>Donate Stationary</h3>
...
export default DonateStationary