...
import donategadget from '../Images/DonateGadgets.png'
import '../styles/DonateClothes.css'
import { Button, Col, Form, Row } from 'react-bootstrap'
import axios from "axios";
function DonateGadgets() {
    ...
    const handleclick = (e) => {
        ...
        axios.post("http://192.168.3.97:5000/api/Gadget/", obj, {
            auth: {
                username: "ramesh",
                password: 12345
            }
        ...
        <div>
            ...
            <div className="row">
                <div className='col-lg-6 col-md-6 col-6'>
                    <img src={donategadget} style={{ height: "709px" }} />
                </div>
                <div className='col-lg-6 col-md-6 col-6'>
                <Form>
