...
import DonateMedical from '../Images/DonateMedical.png'
import { Button, Col, Form, Row } from 'react-bootstrap'
import axios from 'axios'

function DonateHealth() {
    ...
    const handleclick = (e) => {
        ...
        axios.post("http://192.168.3.97:5000/api/Health/", obj, {
            auth: {
                username: "ramesh",
                password: 12345
            }
        ...
        <div>
            ...
            <div className="row">
                <div className='col-lg-6 col-md-6 col-6'>
                    <img src={DonateMedical} style={{ height: "709px" }} />
                </div>
                <div className='col-lg-6 col-md-6 col-6'>
                <Form>
                        <h3 className='textHeading mt-4'>Donate Health</h3>
